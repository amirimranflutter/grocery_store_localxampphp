-- ============================================
-- Grocery Store Enhanced Database Schema
...
-- Suppliers
INSERT INTO suppliers (supplier_id, supplier_name, contact_person, phone, email, city, country) VALUES 
...
-- Products
INSERT INTO products (p_id, p_name, p_description, price, cost_price, stock, cat_id, supplier_id, barcode, sku, unit) VALUES 
...
-- Employees
INSERT INTO employees (emp_id, emp_name, emp_role, emp_phone, emp_email, emp_salary, hire_date) VALUES 
...
-- Customers
INSERT INTO customers (customer_id, customer_name, email, phone, address, city, postal_code, loyalty_points) VALUES 
...
-- Orders
INSERT INTO orders (order_id, customer_id, emp_id, total_amount, discount_amount, tax_amount, final_amount, payment_method, order_status) VALUES 
...
-- Order Items
INSERT INTO order_items (order_item_id, order_id, p_id, quantity, unit_price, subtotal) VALUES 
(1, 1, 1, 2, 2.99, 5.98),
(2, 1, 3, 1, 3.99, 3.99),
(3, 1, 5, 3, 2.49, 7.47),
(4, 2, 2, 5, 1.49, 7.45),
...
INSERT INTO payment_transactions (payment_id, order_id, payment_method, amount, payment_status, transaction_reference) VALUES 
